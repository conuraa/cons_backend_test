...
async def send_manager_reassignment_notification(
    ...
    """
    return  # Queue notifications disabled - bug fix
    ...
    try:
        # Автоуведомление о переназначении менеджера
        # Используем activity message - видно клиенту, НЕ влияет на SLA
